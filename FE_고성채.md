...
2. git 사용법(협업)
    ...
    - 프로젝트 내내 반복
        3.5 작업 시작하기 전 upstream에서 !!! PULL !!!
        4. Branch 생성, 폴더에서 파일 수정, 편집
        5. 폴더에서 파일 수정 사항 반영 (add, commit)
        6. 폴더를 push하여 개인 레포지토리에 반영 
        7. 개인 레포지토리에서 Pull Request 하기
        8. 중앙 레포지토리에서 코드 확인 후 Merge 받기
        9. 폴더의 main 브랜치에 수정사항 반영
        10. 예전 브랜치 삭제 (3.5~10반복)

3. 충돌 발생 시
    1. Web Editor를 통한 충돌 해결
    2. pull을 받아 vscode로 해결
...
4. Django 세팅
    ...
    5. settings.py 설정
        ...
        USE_I18N = True              - Djandgo내 다국어 디원 가능
